...
RATES = {
    ...
    # ⚠ Keys must match the model IDs actually passed to charge(), or the rate
    # silently falls through to the (0.01, "call") default. The -preview image
    # aliases were retired on 2026-06-25; these are their GA names.
