...
- **Controls / input:** `control-surface.js`, `midi-controller.js`, `composer.js` (⚠ GENERATED — edit `composer.jsx` and recompile per its header; React is vendored at `static/shared/vendor/`, no CDN)
...
├── HANDOFF_CLOUD_STORAGE.md # Phase 5 "My creations" gallery — deployed 2026-07-20; + next-slice roadmap
