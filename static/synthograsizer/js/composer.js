/* GENERATED FILE — compiled from composer.jsx (see its header for the
   rebuild command). Edit composer.jsx, not this file. */
const {
  useState,
  useEffect,
  useMemo,
...
const SEED_PROFILES = [{
  ...
  variables: [{
    ...
    valueIdx: 0,
    values: [{
      text: 'surrealist provocateur',
      weight: 3
    }, {
      text: 'Dadaist performance artist',
      weight: 2
    }, {
      text: 'abstract expressionist',
      weight: 1
    }]
  }, {
    name: 'domain',
    ...
    valueIdx: 0,
    values: [{
      text: 'paradoxical compositions',
      weight: 3
    }, {
      text: 'unexpected color pairings',
      weight: 2
    }, {
      text: 'biomechanical hybrids',
      weight: 2
    }]
  }, {
    name: 'approach',
    feature_name: 'Approach',
    valueIdx: 0,
    values: [{
      text: 'smashing incompatible concepts',
      weight: 3
    }, {
      text: 'finding beauty in visual paradoxes',
      weight: 2
    }, {
      text: 'treating every prompt as manifesto',
      weight: 1
    }]
  }],
  anchors: {
  ...
  variables: [{
    ...
    valueIdx: 0,
    values: [{
      text: 'challenge assumptions sharply',
      weight: 3
    }, {
      text: 'cite obscure references',
      weight: 2
    }]
  }, {
    name: 'tone',
  ...
  variables: [{
    ...
    valueIdx: 0,
    values: [{
      text: 'layered subject/style/lens grammar',
      weight: 3
    }, {
      text: 'reverse-engineering reference images',
      weight: 2
    }]
  }, {
    name: 'aspect',
    ...
    values: [{
      ...
      text: 'camera and lens specifications',
      weight: 3
    }, {
      text: 'historical art-movement cues',
      weight: 2
    }]
  }],
  anchors: {
  ...
  variables: [{
    ...
    valueIdx: 0,
    values: [{
      text: 'rogue netrunner',
      weight: 3
    }, {
      text: 'corporate ICEbreaker',
      weight: 2
    }]
  }, {
    name: 'world',
    ...
    valueIdx: 0,
    values: [{
      text: 'Night City 2087',
      weight: 2
    }, {
      text: 'a flooded Hong Kong',
      weight: 2
    }]
  }, {
    name: 'cadence',
    ...
    valueIdx: 0,
    values: [{
      text: 'clipped, jargon-heavy bursts',
      weight: 3
    }, {
      text: 'languid fragments',
      weight: 2
    }]
  }, {
    name: 'influence',
    ...
    valueIdx: 0,
    values: [{
      text: 'Tang dynasty poets',
      weight: 2
    }, {
      text: 'beat generation',
      weight: 2
    }, {
      text: 'Soviet futurists',
      weight: 1
    }]
  }],
  anchors: {
  ...
  variables: [{
    ...
    valueIdx: 0,
    values: [{
      text: 'cut what is not essential',
      weight: 3
    }, {
      text: 'reframe in fewer words',
      weight: 2
    }]
  }, {
    name: 'tone',
    ...
    valueIdx: 0,
    values: [{
      text: 'slowly, with long pauses',
      weight: 2
    }, {
      text: 'gently, almost whispering',
      weight: 2
    }]
  }],
  anchors: {
    agent_name: 'Zen Editor'
  },
  tags: [{
    type: 'builtin',
    label: 'Built-in'
  ...
  variables: [{
    ...
    valueIdx: 0,
    values: [{
      text: 'argue the opposite of consensus',
      weight: 3
    }, {
      text: 'find the strongest counter-case',
      weight: 3
    }]
  }, {
    name: 'constraint',
...
function buildBioSegments(template, anchors, variables) {
  ...
  while ((m = re.exec(template)) !== null) {
    ...
    if (aVal != null) segments.push({
      kind: 'anchor',
      key,
      anchorVal: aVal
    });else if (v) segments.push({
      kind: 'var',
      key,
      featureName: v.feature_name,
      resolvedText: v.values[v.valueIdx]?.text ?? ''
    });else segments.push({
      kind: 'pending',
      key
    });
  ...
  if (last < template.length) segments.push({
    kind: 'text',
...
function KnobSVG({
  ...
  const dx = cx + Math.cos(rad) * dotR,
    dy = cy + Math.sin(rad) * dotR;
  const arc = (s, e, rad) => {
    const sa = (s - 90) * Math.PI / 180,
      ea = (e - 90) * Math.PI / 180;
    const x1 = cx + Math.cos(sa) * rad,
      y1 = cy + Math.sin(sa) * rad;
    const x2 = cx + Math.cos(ea) * rad,
      y2 = cy + Math.sin(ea) * rad;
...
function DraggableKnob({
  ...
  }, /*#__PURE__*/React.createElement(KnobSVG, {
    valueIdx: valueIdx,
    total: total,
    color: color,
    size: size
...
function LibraryRoom({
  ...
  const filtered = useMemo(() => {
    let list = profiles;
    if (cat === 'mine') list = list.filter(p => p.tags.some(t => t.type === 'creator' && t.label === 'You'));else if (cat === 'builtin') list = list.filter(p => p.tags.some(t => t.type === 'builtin'));else if (cat !== 'all') list = list.filter(p => p.category === cat);
    if (search) {
      const s = search.toLowerCase();
      list = list.filter(p => p.name.toLowerCase().includes(s) || p.description.toLowerCase().includes(s) || p.bioTemplate.toLowerCase().includes(s) || p.tags.some(t => t.label.toLowerCase().includes(s)));
    }
    if (sort === 'name') list = [...list].sort((a, b) => a.name.localeCompare(b.name));else if (sort === 'recent') list = [...list].sort((a, b) => (b.updatedAt || 0) - (a.updatedAt || 0));else if (sort === 'category') list = [...list].sort((a, b) => a.category.localeCompare(b.category) || a.name.localeCompare(b.name));
    return list;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "hw-card lib-search-card"
    ...
    className: "step"
  }, "1"), "Browse by category"), /*#__PURE__*/React.createElement("div", {
    className: "lib-side-list"
  ...
  }, c.icon), /*#__PURE__*/React.createElement("span", null, c.label), /*#__PURE__*/React.createElement("span", {
    className: "count"
  }, c.id === 'all' ? profiles.length : c.id === 'mine' ? profiles.filter(p => p.tags.some(t => t.type === 'creator' && t.label === 'You')).length : c.id === 'builtin' ? profiles.filter(p => p.tags.some(t => t.type === 'builtin')).length : profiles.filter(p => p.category === c.id).length)))))), /*#__PURE__*/React.createElement("div", {
    className: "lib-main"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, filtered.length, " profile", filtered.length === 1 ? '' : 's', " \xB7 ", CATEGORIES.find(c => c.id === cat).label), /*#__PURE__*/React.createElement("span", {
    className: "spacer"
  }), /*#__PURE__*/React.createElement("div", {
    className: "lib-sort-pill"
  }, ['recent', 'name', 'category'].map(s => /*#__PURE__*/React.createElement("button", {
    key: s,
    ...
    className: "hw-btn tiny ghost",
    onClick: () => setOverflowOpen(o => !o),
    title: "More actions"
  }, "\u22EF"), overflowOpen && /*#__PURE__*/React.createElement("div", {
    className: "lib-popover"
  }, /*#__PURE__*/React.createElement("div", {
    className: "lib-pop-item",
    onClick: () => {
      onExport?.();
      setOverflowOpen(false);
    }
  }, "\u2193 Export All"), /*#__PURE__*/React.createElement("div", {
    className: "lib-pop-item",
    onClick: () => {
      onRestoreFromDisk?.();
      setOverflowOpen(false);
    }
  }, "\uD83D\uDCC1 Restore from disk\u2026"))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    },
    ref: createRef
  ...
  }, "+ Create Profile"), createOpen && /*#__PURE__*/React.createElement("div", {
    className: "lib-popover lib-popover-create"
  }, /*#__PURE__*/React.createElement("div", {
    className: "lib-pop-item",
    onClick: () => {
      onCreate?.();
  ...
  }, "\u25A2 Blank canvas ", /*#__PURE__*/React.createElement("span", {
    className: "lib-pop-hint"
  ...
  }, "\u270E From description ", /*#__PURE__*/React.createElement("span", {
    className: "lib-pop-hint"
  ...
  }, "\u2337 From image ", /*#__PURE__*/React.createElement("span", {
    className: "lib-pop-hint"
  ...
  }, "\u2191 Import JSON ", /*#__PURE__*/React.createElement("span", {
    className: "lib-pop-hint"
  }, "\u21E7I"))))), /*#__PURE__*/React.createElement("div", {
    className: "lib-cards"
  }, filtered.map(p => /*#__PURE__*/React.createElement(ProfileCard, {
    key: p.id,
    profile: p,
    onEdit: () => onEdit(p),
    ...
    className: "lib-empty-msg"
  }, search ? /*#__PURE__*/React.createElement("span", null, "No profiles match ", /*#__PURE__*/React.createElement("strong", null, "\"", search, "\""), cat !== 'all' ? ` in ${CATEGORIES.find(c => c.id === cat)?.label || cat}` : '') : /*#__PURE__*/React.createElement("span", null, "No profiles in ", /*#__PURE__*/React.createElement("strong", null, CATEGORIES.find(c => c.id === cat)?.label || cat))), /*#__PURE__*/React.createElement("div", {
    className: "lib-empty-actions"
  }, search && /*#__PURE__*/React.createElement("button", {
    className: "hw-btn tiny",
    onClick: () => setSearch('')
  }, "\u232B Clear search"), cat !== 'all' && /*#__PURE__*/React.createElement("button", {
    className: "hw-btn tiny",
    onClick: () => setCat('all')
  }, "\u2295 All Profiles"))))));
}
...
function ProfileCard({
  ...
  const previewBioSegs = useMemo(() => buildBioSegments(profile.bioTemplate, profile.anchors, profile.variables), [profile]);
  useEffect(() => {
    if (!menuOpen) return;
    const handler = e => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "pc-avatar pc-monogram",
    style: {
      background: catGradient(profile.category)
    }
  }, profileMonogram(profile.name)), /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 0,
      flex: 1
    }
    ...
    className: "pc-cat"
  }, profile.category))), /*#__PURE__*/React.createElement("div", {
    className: "pc-bio"
  }, previewBioSegs.map((seg, i) => {
    if (seg.kind === 'anchor') return /*#__PURE__*/React.createElement("em", {
      key: i
    }, seg.anchorVal);
    if (seg.kind === 'var') return /*#__PURE__*/React.createElement("em", {
      key: i,
      style: {
        borderColor: 'var(--hw-amb)',
        color: 'var(--hw-amb)'
      }
    }, "\u21BB ", seg.featureName);
    if (seg.kind === 'pending') return /*#__PURE__*/React.createElement("span", {
      key: i
    }, `{{${seg.key}}}`);
    return /*#__PURE__*/React.createElement(React.Fragment, {
      key: i
    }, seg.text);
  })), varCount > 0 && /*#__PURE__*/React.createElement("div", {
    className: "pc-meta"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pc-vars"
  }, profile.variables.slice(0, 4).map((v, i) => /*#__PURE__*/React.createElement("span", {
    className: "knob-mini",
    key: i,
    title: v.feature_name,
    style: {
      '--rot': -90 + v.valueIdx / Math.max(1, v.values.length - 1) * 180 + 'deg'
    }
  })), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 4
    }
  }, varCount, " var", varCount !== 1 ? 's' : ''))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u25B7 Test"), onDelete && /*#__PURE__*/React.createElement("div", {
    className: "pc-menu-item pc-menu-danger",
    onClick: e => {
      e.stopPropagation();
      onDelete();
      setMenuOpen(false);
  ...
  }, profile.tags.map((t, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    className: 'pc-tag ' + t.type,
    onClick: e => {
      e.stopPropagation();
      onTagClick && onTagClick(t.label);
    }
  }, t.label))), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn tiny primary",
    onClick: e => {
      e.stopPropagation();
      onSendToSession();
    }
...
const DEFAULT_GEN_INSTRUCTIONS = 'Match the tone and energy of the user\'s description precisely. Lean positive and collaborative by default — avoid gratuitous darkness or cynicism unless the description calls for it. Write variable values as concrete, vivid phrases (3–12 words) that slot naturally into the bio template.';
function EditorRoom({
  profile,
  setProfile,
  onAddToSession,
  ...
  const [genInstructions, setGenInstructionsState] = useState(() => {
    try {
      return localStorage.getItem(GEN_INSTRUCTIONS_KEY) || DEFAULT_GEN_INSTRUCTIONS;
    } catch (_) {
      return DEFAULT_GEN_INSTRUCTIONS;
    }
  });
  ...
  const setGenInstructions = val => {
    ...
    try {
      localStorage.setItem(GEN_INSTRUCTIONS_KEY, val);
    } catch (_) {}
  };
  ...
  useEffect(() => {
    const update = () => {
      ...
      if (dt < 3) setSavedAgo('just now');else if (dt < 60) setSavedAgo(`${Math.floor(dt)}s ago`);else if (dt < 3600) setSavedAgo(`${Math.floor(dt / 60)}m ago`);else setSavedAgo(`${Math.floor(dt / 3600)}h ago`);
    };
    update();
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem(`composer_test_history_${profile.id}`, JSON.stringify(testHistory.slice(-30)));
    } catch (_) {}
  ...
  const previewSegs = useMemo(() => buildBioSegments(profile.bioTemplate, profile.anchors, profile.variables), [profile]);
  ...
  const adjustWeight = (varIdx, valIdx, delta) => {
    ...
    vs[valIdx] = {
      ...vs[valIdx],
      weight: Math.max(1, Math.min(9, cur + delta))
    };
    updateVar(varIdx, {
      values: vs
    });
  ...
  const generateValuesForVar = async varIdx => {
    ...
    try {
      ...
      const newValues = arr.filter(x => typeof x === 'string').map(x => ({
        text: x.trim(),
        weight: 1
      }));
      updateVar(varIdx, {
        values: [...v.values, ...newValues]
      });
  ...
  const setAnchor = (key, val) => setProfile({
    ...profile,
    anchors: {
      ...profile.anchors,
      [key]: val
  ...
  const handleChipClick = token => {
    if (token.kind === 'pending') {
      const choice = (window.prompt(`"${token.name}" is unbound. Register as:\n  v = variable (knob)\n  a = anchor (fixed text)\nor cancel:`, 'v') || '').trim().toLowerCase();
      if (choice === 'v') {
        setProfile({
          ...profile,
          variables: [...profile.variables, {
            name: token.name,
            feature_name: token.name,
            valueIdx: 0,
            values: [{
              text: 'option',
              weight: 1
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "lbl-mini"
  }, "Create from description"), /*#__PURE__*/React.createElement("input", {
    value: aiPrompt,
    ...
    className: "hw-btn primary",
    onClick: () => onGenerate && onGenerate(aiPrompt, genInstructions)
  }, "\u2726 Generate"), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn gen-instr-toggle",
    onClick: () => setShowGenInstructions(v => !v),
    title: "Edit generation instructions"
  }, "\u2699 ", showGenInstructions ? 'Hide' : 'Instructions'))), /*#__PURE__*/React.createElement("div", {
    className: "lbl-mini gen-context-hint",
    style: {
      padding: '2px 12px 6px',
      color: 'var(--hw-text-label)'
    }
  }, "\u2726 sends: name \xB7 category \xB7 description \xB7 bio \xB7 variables \xB7 anchors"), showGenInstructions && /*#__PURE__*/React.createElement("div", {
    className: "gen-instr-panel"
  }, /*#__PURE__*/React.createElement("div", {
    className: "gen-instr-header"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lbl-mini"
  }, "Generation Instructions"), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn",
    style: {
      fontSize: 9,
      padding: '1px 6px'
    ...
    className: "gen-instr-note"
  }, "Controls tone and style. Schema structure (JSON format, variables, anchors) is always enforced."), /*#__PURE__*/React.createElement("textarea", {
    className: "gen-instr-area",
    ...
    className: "step"
  }, "A"), "Identity \u2014 sent to generation"), /*#__PURE__*/React.createElement("div", {
    className: `ed-meta-row${aiPrompt.trim() ? ' gen-context-active' : ''}`,
    style: {
      gridTemplateColumns: '60px 1fr 160px 110px'
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "ed-input-grp"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lbl"
    ...
    className: "lbl"
  }, "Display name (also agent name)"), /*#__PURE__*/React.createElement("input", {
    className: "ed-input big",
    value: profile.name,
    onChange: e => setProfile({
      ...profile,
      name: e.target.value,
    ...
    value: "imagegen"
  }, "imagegen"), /*#__PURE__*/React.createElement("option", {
    value: "discussion"
  }, "discussion"), /*#__PURE__*/React.createElement("option", {
    value: "roleplay"
  }, "roleplay"), /*#__PURE__*/React.createElement("option", {
    value: "custom"
  }, "custom"))), /*#__PURE__*/React.createElement("div", {
    className: "ed-input-grp"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lbl"
  }, "Avatar tint"), /*#__PURE__*/React.createElement("input", {
    className: "ed-input",
    type: "color",
    value: profile.color,
    onChange: e => setProfile({
  ...
  }, "One-line description"), /*#__PURE__*/React.createElement("input", {
    className: "ed-input",
    style: {
      width: '100%'
    },
    ...
    className: `hw-card ed-bio-card${aiPrompt.trim() ? ' gen-context-active' : ''}`,
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: "note-pin"
  }, tokens.length, " tokens \xB7 ", tokens.filter(t => t.kind === 'pending').length, " unbound"), /*#__PURE__*/React.createElement("span", {
    className: "card-label"
  }, /*#__PURE__*/React.createElement("span", {
    className: "step"
  }, "B"), "Bio Template \u2014 sent to generation"), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 12px'
    }
    ...
    id: "bio-area",
    ref: bioAreaRef,
    className: "ed-bio-area",
    value: profile.bioTemplate,
    onChange: e => setProfile({
      ...profile,
      bioTemplate: e.target.value
    })
  })), /*#__PURE__*/React.createElement("div", {
    className: "ed-bio-foot"
  }, /*#__PURE__*/React.createElement("span", {
    className: "hint"
  ...
  }, '{{name}}'), " for variables/anchors. Click a chip to insert \xB7 click an unbound chip to register it."), /*#__PURE__*/React.createElement("div", {
    className: "ed-bio-tokens"
  }, tokens.map((t, i) => {
    if (t.kind === 'pending') {
      return /*#__PURE__*/React.createElement("span", {
        key: i,
        className: "token-chip pending",
    ...
    }, t.kind === 'var' ? '↻' : '⚓', " ", t.name), /*#__PURE__*/React.createElement("span", {
      className: "chip-caret",
      onClick: e => {
        e.stopPropagation();
        const rect = e.currentTarget.getBoundingClientRect();
        setChipMenu(prev => prev?.token.name === t.name ? null : {
          token: t,
          x: rect.left,
          y: rect.bottom + 4,
          vIdx
    ...
    className: "step"
  }, "C"), "Variables \u2014 these become Knobs \xB7 drag ", /*#__PURE__*/React.createElement("code", {
    style: {
      fontFamily: 'inherit'
    }
  }, "\u22EE\u22EE"), " to reorder"), /*#__PURE__*/React.createElement("div", {
    className: "var-mgr"
  }, /*#__PURE__*/React.createElement("div", {
    className: "var-bank"
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, v.values.length, " values \xB7 idx ", v.valueIdx)), /*#__PURE__*/React.createElement("div", {
      className: "var-vals-col"
    }, v.values.map((val, vi) => /*#__PURE__*/React.createElement("span", {
      key: vi,
      className: "val-pill val-pill-editable",
      style: vi === v.valueIdx ? {
        borderColor: 'var(--hw-amb)',
    ...
    }, /*#__PURE__*/React.createElement("span", null, val.text), /*#__PURE__*/React.createElement("span", {
      className: "val-pill-weight-ctl",
      ...
      className: 'wt' + ((val.weight ?? 1) >= 3 ? ' hi' : ''),
      title: "Weight (random pick probability)"
    }, "\xD7", val.weight ?? 1), /*#__PURE__*/React.createElement("button", {
      className: "wt-btn",
      onClick: e => {
        e.stopPropagation();
        adjustWeight(idx, vi, 1);
      ...
      onClick: e => {
        ...
        updateVar(idx, {
          values: vs,
          valueIdx: Math.min(v.valueIdx, vs.length - 1)
        });
      },
      disabled: v.values.length <= 1,
      title: v.values.length <= 1 ? 'A variable must have at least one value' : 'Remove value'
    }, "\xD7"))), /*#__PURE__*/React.createElement("span", {
      className: "val-pill add",
      onClick: e => {
        e.stopPropagation();
        const t = window.prompt('New value text:');
        if (!t) return;
        updateVar(idx, {
          values: [...v.values, {
            text: t,
      ...
      onClick: e => {
        e.stopPropagation();
        generateValuesForVar(idx);
      },
      title: "Ask Gemini to suggest 4 more values for this variable",
      style: generatingForVar === idx ? {
        opacity: 0.5,
        cursor: 'wait',
        borderColor: 'var(--hw-amb)'
      } : {}
    }, generatingForVar === idx ? '✦ generating…' : '✦ gen values')), /*#__PURE__*/React.createElement("div", {
      className: "var-row-actions"
    }, /*#__PURE__*/React.createElement(DraggableKnob, {
      valueIdx: v.valueIdx,
      total: v.values.length,
      color: "#7a6e5e",
      size: 36,
      ariaLabel: v.feature_name || v.name,
      onChange: next => updateVar(idx, {
        valueIdx: next
      })
    }), /*#__PURE__*/React.createElement("button", {
      className: "hw-btn tiny ghost",
    ...
    onClick: addVar
  }, "+ Add Variable")))), /*#__PURE__*/React.createElement("div", {
    className: "hw-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label"
  }, /*#__PURE__*/React.createElement("span", {
    className: "step"
  }, "D"), "Anchors \u2014 fixed text constants \xB7 click a key to rename"), /*#__PURE__*/React.createElement("div", {
    className: "anchor-tbl"
    ...
    }), isAutoBound ? /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 11,
        color: 'var(--hw-blue)',
        padding: '0 4px'
      },
      title: "Auto-bound to display name"
    }, "\uD83D\uDD17") : /*#__PURE__*/React.createElement("button", {
      className: "x",
      onClick: () => delAnchor(k)
    }, "\u2715"));
    ...
    className: "hw-card preview-card",
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "step"
  }, "P"), "Live Preview \xB7 resolved bio"), /*#__PURE__*/React.createElement("div", {
    className: "pv-stack"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pv-lcd"
  }, previewSegs.map((seg, i) => {
    if (seg.kind === 'anchor') return /*#__PURE__*/React.createElement("span", {
      key: i,
      className: "anchor-fill"
    }, seg.anchorVal);
    if (seg.kind === 'var') return /*#__PURE__*/React.createElement("span", {
      key: i,
      className: "var-fill"
    }, seg.resolvedText);
    if (seg.kind === 'pending') return /*#__PURE__*/React.createElement("span", {
    ...
    className: "pv-knobs"
  }, profile.variables.slice(0, 6).map((v, i) => /*#__PURE__*/React.createElement("div", {
    className: "knob-cell",
    key: i
  }, /*#__PURE__*/React.createElement(DraggableKnob, {
    valueIdx: v.valueIdx,
    ...
    onChange: next => updateVar(i, {
      valueIdx: next
    })
  }), /*#__PURE__*/React.createElement("div", {
    className: "knob-name"
  }, v.feature_name), /*#__PURE__*/React.createElement("div", {
    className: "knob-val"
  }, v.values[v.valueIdx]?.text)))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDFB2 Reroll all"), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn",
    onClick: () => {
  ...
  }, "\u2398 Copy bio"), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("button", {
  ...
  }, "+ Add to Session"))), /*#__PURE__*/React.createElement("div", {
    className: "hw-card test-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label"
  }, /*#__PURE__*/React.createElement("span", {
    className: "step"
  }, "T"), "Test Run \xB7 solo chat"), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '6px 0'
    }
  }, testHistory.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: 'var(--hw-text-label)',
      textAlign: 'center',
  ...
  }, "No test messages yet \u2014 try one below."), testHistory.map((m, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: 'test-bubble' + (m.who === 'You' ? ' user' : ''),
    style: m.pending ? {
      opacity: 0.6,
      fontStyle: 'italic'
    } : {}
  ...
  }, m.who, m.pending ? ' · thinking' : ''), /*#__PURE__*/React.createElement("div", null, m.text)))), /*#__PURE__*/React.createElement("div", {
    className: "test-bar"
  }, /*#__PURE__*/React.createElement("input", {
    value: testInput,
  ...
  }, "Test resolves the bio with current knob values and pings Gemini once.")), /*#__PURE__*/React.createElement("div", {
    className: "hw-card",
    style: {
      padding: '8px 12px',
      display: 'flex',
    ...
    title: "Save a copy of this profile under a new name"
  }, "\u2398 Save As\u2026")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6
    }
  ...
  }, "Auto-saved ", savedAgo, " \xB7 localStorage"))), chipMenu && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    className: "chip-pop-item",
    onClick: () => {
      insertToken(chipMenu.token.kind, chipMenu.token.name);
      setChipMenu(null);
    }
  }, "\u21B3 Insert ", `{{${chipMenu.token.name}}}`), chipMenu.token.kind === 'var' && chipMenu.vIdx >= 0 && /*#__PURE__*/React.createElement("div", {
    className: "chip-pop-item",
    onClick: () => {
      setActiveVarIdx(chipMenu.vIdx);
      document.getElementById(`var-row-${chipMenu.vIdx}`)?.scrollIntoView({
        block: 'center',
        behavior: 'smooth'
      });
      setChipMenu(null);
    }
  }, "\u2933 Jump to variable"), chipMenu.token.kind === 'var' && /*#__PURE__*/React.createElement("div", {
    className: "chip-pop-item",
    onClick: () => {
      setProfile({
        ...profile,
  ...
  }, "\u2295 Promote to anchor")), document.body));
}
...
function SessionRoom({
  ...
  const tplEntries = useMemo(() => {
    ...
    return Object.entries(sessionTemplates).map(([key, tpl]) => ({
      key,
      ...tpl
    }));
  }, [sessionTemplates]);
  ...
  const ANCHOR_TEMPLATES = [{
    k: 'tone',
    v: 'professional but playful'
  }, {
    k: 'output_rules',
    v: 'Keep replies under 80 words. Use [IMAGE:] for visual ideas.'
  }, {
    k: 'session_context',
    v: 'Multi-agent creative studio session.'
  }, {
    k: 'audience',
    v: 'a curious peer, not a beginner'
  }, {
    k: 'forbidden',
    v: 'no LLM-disclaimer language; no hedging'
  }];
  ...
  const addToSlot = (profileId, atIdx = null) => {
    ...
    if (atIdx == null || atIdx >= next.length) next.push(slot);else next.splice(atIdx, 0, slot);
  ...
  const onSlotDrop = (e, slotIdx) => {
    ...
    if (profileId) {
      ...
      if (Number.isFinite(fromIdx) && fromIdx !== slotIdx) {
        if (slotIdx < sessionAgents.length) swapSlots(fromIdx, slotIdx);else {
  ...
  const SUGG = activeTpl && activeTpl.suggestedGoals && activeTpl.suggestedGoals.length > 0 ? activeTpl.suggestedGoals : ['Write the weirdest text-to-image prompts possible', 'Iterate one concept through 10 evolutions', 'Pitch a band poster, refine the visual language', 'Argue both sides of "AI art is real art"'];
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: 'relative',
      outline: rosterDropArmed ? '2px dashed var(--hw-pink)' : 'none',
      outlineOffset: '-2px'
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label"
    ...
    className: "step"
  }, "1"), "Roster \xB7 click or drag ", rosterDropArmed ? '· drop to remove from session' : ''), /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "cat"
    }, p.category, " \xB7 ", p.variables.length, " knobs")), inSession ? /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9,
        color: 'var(--hw-grn)'
      }
    ...
    placeholder: "Session name (e.g. Prompt Alchemy Lab)"
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
    ...
    className: "meta"
  }, filled, " / ", slots, " channels"), /*#__PURE__*/React.createElement("span", {
    className: "meta"
  }, "\xB7"), /*#__PURE__*/React.createElement("span", {
    className: "meta"
  }, "Resolution mode"), /*#__PURE__*/React.createElement("div", {
    className: "res-toggle"
  }, /*#__PURE__*/React.createElement("button", {
    className: resolutionMode === 'once' ? 'active' : '',
    onClick: () => setResolutionMode('once'),
    title: "Resolve each agent's bio once when the session starts."
  }, "once at start"), /*#__PURE__*/React.createElement("button", {
    className: resolutionMode === 'each_turn' ? 'active' : '',
    disabled: true,
    style: {
      opacity: 0.5,
      cursor: 'not-allowed'
  ...
  }, "each turn")), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "hw-btn tiny",
    onClick: () => setShowLoadMenu(s => !s),
    title: "Load a saved session preset"
  }, "\u25BE Sessions (", savedSessions.length, ")"), showLoadMenu && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      right: 0,
      top: 'calc(100% + 4px)',
  ...
  }, "No saved sessions yet \u2014 use \uD83D\uDCBE Save below.") : savedSessions.map(s => /*#__PURE__*/React.createElement("div", {
    key: s.id,
    style: {
      padding: '8px 10px',
      borderBottom: '1px solid var(--hw-border-soft)',
      display: 'flex',
      alignItems: 'center',
      gap: 8
    }
    ...
    onClick: () => {
      onLoadSession && onLoadSession(s.id);
  ...
  }, s.name || '(unnamed)'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: 'var(--hw-text-dim)',
      letterSpacing: '.06em'
    }
  }, (s.agents || []).length, " agents \xB7 ", Object.keys(s.sharedAnchors || {}).length, " anchors")), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn tiny ghost",
    style: {
      color: 'var(--hw-pink)'
    },
    ...
    if (!p) {
      ...
      }, "missing profile"), /*#__PURE__*/React.createElement("span", {
        className: "x",
        onClick: () => removeSlot(slotIdx)
      }, "\u2715")), /*#__PURE__*/React.createElement("div", {
        className: "channel-num"
      }, "CH ", String(slotIdx + 1).padStart(2, '0'), " \xB7 profileId ", slot.profileId), /*#__PURE__*/React.createElement("div", {
        style: {
          padding: 16,
          fontSize: 10,
          color: 'var(--hw-text-dim)',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "channel-num"
    }, "CH ", String(slotIdx + 1).padStart(2, '0'), " \xB7 ", p.icon, " \xB7 ", p.category), /*#__PURE__*/React.createElement("div", {
      className: "channel-knobs"
    }, p.variables.slice(0, 4).map((v, vi) => {
      const locked = slot.overrides?.[v.name] !== undefined;
      const idx = effectiveIdx(slot, v);
      return /*#__PURE__*/React.createElement("div", {
        key: vi,
        className: 'channel-knob' + (locked ? ' locked' : ''),
        onClick: () => toggleLock(slotIdx, v.name),
        title: locked ? 'Locked at this value · click to unlock (re-randomize) · drag knob to change locked value' : 'Click to lock current value · drag knob to lock at a different value'
      }, /*#__PURE__*/React.createElement(DraggableKnob, {
        valueIdx: idx,
        total: v.values.length,
        color: p.color,
        ...
        className: "lbl"
      }, v.feature_name), /*#__PURE__*/React.createElement("span", {
        className: "val"
      }, v.values[idx]?.text));
    })), /*#__PURE__*/React.createElement("div", {
      className: "channel-foot"
    }, /*#__PURE__*/React.createElement("button", {
      className: "hw-btn tiny ghost",
      onClick: () => onEditAgent(p)
  ...
  }, tplEntries.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: 'hw-card qs-card' + (qsCollapsed ? ' collapsed' : '')
  }, /*#__PURE__*/React.createElement("div", {
    className: "qs-header",
    onClick: () => setQsCollapsed(c => !c)
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label",
    style: {
      padding: 0
    ...
    className: "step"
  }, "\u26A1"), "Quick Start \xB7 Session Templates"), /*#__PURE__*/React.createElement("span", {
    className: "qs-chevron"
  }, "\u25BE"), activeTemplateKey && qsCollapsed && /*#__PURE__*/React.createElement("span", {
    className: "qs-loaded-badge"
  }, "\u2713 ", sessionTemplates?.[activeTemplateKey]?.name)), /*#__PURE__*/React.createElement("div", {
    className: "qs-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qs-cats"
  }, tplCategories.map(c => /*#__PURE__*/React.createElement("span", {
    key: c.id,
    className: 'qs-cat-pill' + (qsCat === c.id ? ' active' : ''),
    onClick: () => setQsCat(c.id)
  }, c.label))), /*#__PURE__*/React.createElement("div", {
    className: "qs-grid"
  }, filteredTpls.map(t => /*#__PURE__*/React.createElement("div", {
    key: t.key,
    className: 'qs-tpl' + (activeTemplateKey === t.key ? ' active' : ''),
    onClick: () => loadTemplate(t.key),
    title: t.description || t.name
  }, /*#__PURE__*/React.createElement("div", {
    className: "qs-tpl-name"
  }, t.name), /*#__PURE__*/React.createElement("div", {
    className: "qs-tpl-meta"
  }, /*#__PURE__*/React.createElement("span", {
    className: "qs-dot",
    style: {
      background: CAT_COLORS[t.category]?.[0] || '#8a7e6e'
    }
  }), /*#__PURE__*/React.createElement("span", null, t.category), /*#__PURE__*/React.createElement("span", null, "\xB7"), /*#__PURE__*/React.createElement("span", null, (t.agents || []).length, " agents"))))))), /*#__PURE__*/React.createElement("div", {
    className: "hw-card goal-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label"
  }, /*#__PURE__*/React.createElement("span", {
    className: "step"
  }, "2"), "Session Goal"), /*#__PURE__*/React.createElement("textarea", {
    value: goal,
    onChange: e => setGoal(e.target.value),
    placeholder: "What is this ensemble trying to do?"
  }), /*#__PURE__*/React.createElement("div", {
    className: "goal-suggestions"
  }, SUGG.map((s, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    className: "goal-sugg",
    onClick: () => setGoal(s)
  }, "\u2191 ", s)))), /*#__PURE__*/React.createElement("div", {
    className: "hw-card anchor-side"
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label"
  }, /*#__PURE__*/React.createElement("span", {
    className: "step"
  }, "3"), "Shared Anchors \xB7 injected into every bio"), Object.entries(sharedAnchors).map(([k, v]) => /*#__PURE__*/React.createElement("div", {
    key: k,
    className: "anch-row",
    style: {
      display: 'grid',
    ...
    onClick: () => addAnchor()
  }, "+ Add shared anchor"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 4
    }
  }, ANCHOR_TEMPLATES.map(t => /*#__PURE__*/React.createElement("button", {
    key: t.k,
    className: "hw-btn tiny ghost",
    ...
    className: "hw-card launch-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "launch-stat"
  }, /*#__PURE__*/React.createElement("span", {
    className: "num"
  }, filled), "agents"), /*#__PURE__*/React.createElement("span", {
    className: "launch-stat"
  }, /*#__PURE__*/React.createElement("span", {
    className: "num"
  }, Object.keys(sharedAnchors).length), "anchors"), /*#__PURE__*/React.createElement("span", {
    className: "launch-stat"
  }, /*#__PURE__*/React.createElement("span", {
    className: "num"
  }, sessionAgents.reduce((acc, a) => {
    const p = profiles.find(p => p.id === a.profileId);
    return acc + (p?.variables.length || 0);
  }, 0)), "knobs"), /*#__PURE__*/React.createElement("span", {
    className: "grow"
  }), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn",
    onClick: onSaveSession,
    disabled: filled === 0,
    title: "Save this session as a reusable preset"
  }, "\uD83D\uDCBE Save"), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn",
    onClick: () => setShowBioPreview(true),
    disabled: filled === 0,
    title: "Preview resolved bios before launch"
  }, "\uD83D\uDC41 Preview"), /*#__PURE__*/React.createElement("button", {
    className: "launch-btn",
    onClick: onLaunch,
    disabled: filled === 0
  }, "\u25B6 Launch Session")), showBioPreview && /*#__PURE__*/React.createElement("div", {
    className: "bio-preview-overlay"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bio-preview-panel hw-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "card-label",
    style: {
      display: 'flex',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDC41 Bio preview \xB7 exactly what will be posted"), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn tiny ghost",
    onClick: () => setShowBioPreview(false)
  }, "\u2715")), /*#__PURE__*/React.createElement("div", {
    className: "bio-preview-list"
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: si,
      className: "bio-preview-agent"
    }, /*#__PURE__*/React.createElement("div", {
      className: "bio-preview-agent-head"
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        width: 8,
        height: 8,
      ...
      className: "hw-btn tiny",
      onClick: () => rerollAgent(si),
      title: "Re-randomize unlocked variables"
    }, "\uD83C\uDFB2 reroll")), /*#__PURE__*/React.createElement("div", {
      className: "bio-preview-bio"
    }, bio));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 14px',
  ...
  }, "\u25B6 Looks good \u2014 Launch")))), conflictPending && /*#__PURE__*/React.createElement("div", {
    className: "conflict-overlay"
  }, /*#__PURE__*/React.createElement("div", {
    className: "conflict-panel"
  }, /*#__PURE__*/React.createElement("div", {
    className: "conf-head"
  }, "Session has agents"), /*#__PURE__*/React.createElement("div", {
    className: "conf-body"
  }, "You have ", sessionAgents.length, " agent", sessionAgents.length !== 1 ? 's' : '', " in the current session. Loading ", /*#__PURE__*/React.createElement("strong", null, conflictPending.tpl.name), " (", conflictPending.resolvedSlots.length, " agents) \u2014 how would you like to proceed?"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "hw-btn",
    onClick: () => handleConflict('append'),
    title: "Add template agents to existing slots (up to 6)"
  }, "+ Append"), /*#__PURE__*/React.createElement("button", {
    className: "hw-btn primary",
    onClick: () => handleConflict('replace'),
    title: "Clear current agents and load the template"
  }, "\u21BB Replace"))))));
}
...
function RunRoom({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "step"
  }, "\u25B6"), "Launch Staging"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, a.profile.name), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("span", {
  ...
  }, "\u2713"), " ", agents.length, " agent", agents.length !== 1 ? 's' : '', " loaded into chatroom"), goal && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--hw-grn)'
    }
  }, "\u2713"), " Goal set \xB7 ", Object.keys(sharedAnchors).length, " shared anchor", Object.keys(sharedAnchors).length !== 1 ? 's' : '', " merged")), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u25B6 Open in Agent Studio")), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    className: "hw-btn ghost",
    onClick: onBack
  }, "\u2190 Back to Compose"), goal && /*#__PURE__*/React.createElement("button", {
    className: "hw-btn",
    onClick: copyGoal
  }, "\u2398 Copy Goal"), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
...
function App() {
  ...
  useEffect(() => {
    whenStoreReady(async store => {
      ...
      if (window.autoMigrateBuiltInPresets && window.AS_AGENT_TEMPLATES_REF) {
        try {
          window.autoMigrateBuiltInPresets(window.AS_AGENT_TEMPLATES_REF);
        } catch (_) {}
      }
  ...
  useEffect(() => {
    ...
    let raw;
    try {
      raw = sessionStorage.getItem('pendingTasteSession');
    } catch (_) {
      return;
    }
    if (!raw) return;
    ...
    try {
      ...
      try {
        sessionStorage.removeItem('pendingTasteSession');
      } catch (_) {}
      return;
    }
    try {
    ...
    setTimeout(() => {
      window.dispatchEvent(new CustomEvent('composer:command', {
        detail: {
          action: 'openSessionFromTasteProfile',
          ...payload
        }
      }));
    }, 0);
        ...
        case 'openSessionFromTasteProfile':
          {
            ...
            const slots = (d.agents || []).map(a => a && a.profileId && latest.find(p => p.id === a.profileId) ? {
  ...
  useEffect(() => {
    const handler = e => {
      ...
      const isText = tag === 'INPUT' || tag === 'TEXTAREA' || tag === 'SELECT' || e.target && e.target.isContentEditable;

      // Cmd/Ctrl+S anywhere → save toast (everything auto-saves on edit)
      if ((e.metaKey || e.ctrlKey) && (e.key === 's' || e.key === 'S')) {
        e.preventDefault();
        setToast({
          msg: 'Profile saved · auto-saving is on',
          kind: 'ok'
        });
    ...
    input.onchange = async e => {
      ...
      try {
        ...
        const gr = await fetch(`${SYNTHO_API}/api/generate/template`, {
          ...
          body: JSON.stringify({
            mode: 'agent_profile',
            prompt: `An agent inspired by: ${description}`
          })
        });
        ...
        const fresh = {
          ...
          variables: (tpl.variables || []).map(v => ({
            ...
            valueIdx: 0,
            values: (v.values || []).map(val => typeof val === 'string' ? {
              text: val,
              weight: 1
            } : {
              weight: 1,
  ...
  const fetchTasteVector = async () => {
    ...
    const sample = profiles.filter(p => p.tags && p.tags.some(t => t.type === 'creator' || t.type === 'remix')).slice(0, 8);
  ...
  const liveTweakKnob = async (slotIdx, varIdx) => {
    ...
    const currentIdx = currentText !== undefined ? Math.max(0, v.values.findIndex(val => val.text === currentText)) : v.valueIdx;
  ...
  const launchSession = async () => {
    ...
    try {
      ...
      if (window.agentStudio && typeof window.agentStudio.openWithSession === 'function') {
        ...
        try {
          localStorage.setItem('synthograsizerMode', 'default');
        } catch (_) {}
              ...
              slots: sessionAgents.map((slot, idx) => {
                ...
                return {
                  ...
                  knobs: (p?.variables || []).map(v => ({
                    ...
                    selectedText: slot.overrides?.[v.name] !== undefined ? slot.overrides[v.name] : v.values[v.valueIdx]?.text,
  ...
  const saveSessionPreset = async () => {
    ...
    const name = askName ? (window.prompt('Name this session:', sessionName) || '').trim() : sessionName;
  ...
  const loadSessionPreset = async id => {
    try {
      ...
      setSessionAgents((s.agents || []).map(a => ({
        profileId: a.profileId,
        overrides: a.overrides || {}
      })));
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    id: "rn-mount"
  }), room === 'library' && /*#__PURE__*/React.createElement(LibraryPortal, null, /*#__PURE__*/React.createElement(LibraryRoom, {
    profiles: profiles,
    ...
    onSendToSession: p => {
      if (!sessionAgents.find(a => a.profileId === p.id)) {
        setSessionAgents([...sessionAgents, {
          profileId: p.id,
          overrides: {}
        }]);
      }
  ...
  })), room === 'editor' && editingProfile && /*#__PURE__*/React.createElement(EditorPortal, null, /*#__PURE__*/React.createElement(EditorRoom, {
  ...
  })), room === 'session' && /*#__PURE__*/React.createElement(SessionPortal, null, /*#__PURE__*/React.createElement(SessionRoom, {
    profiles: profiles,
  ...
  })), room === 'run' && /*#__PURE__*/React.createElement(RunPortal, null, /*#__PURE__*/React.createElement(RunRoom, {
    profiles: profiles,
    sessionAgents: sessionAgents,
    sharedAnchors: sharedAnchors,
    goal: goal,
...
function LibraryPortal({
  ...
  return ReactDOM.createPortal(children, document.getElementById('room-library'));
}
function EditorPortal({
  children
}) {
  return ReactDOM.createPortal(children, document.getElementById('room-editor'));
}
function SessionPortal({
  children
}) {
  return ReactDOM.createPortal(children, document.getElementById('room-session'));
}
function RunPortal({
  children
}) {
  return ReactDOM.createPortal(children, document.getElementById('room-run'));
}
...
class ComposerErrorBoundary extends React.Component {
  ...
  render() {
    ...
    }, String(this.state.error?.stack || this.state.error || 'unknown error')), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8,
        marginTop: 12
...
(function mountComposerApp() {
  ...
  ReactDOM.createRoot(target).render(/*#__PURE__*/React.createElement(ComposerErrorBoundary, null, /*#__PURE__*/React.createElement(App, null)));
})();
...
(function setupComposerAPI() {
  ...
  window.Composer = {
     ...
     */
    openSessionFromRecipe({
      agents = [],
      goal = ''
    } = {}) {
      send({
        action: 'openSessionFromRecipe',
        agents,
        goal
      });
    }
