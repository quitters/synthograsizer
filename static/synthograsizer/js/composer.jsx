/**
 * COMPOSER SOURCE (JSX) — this file is NOT loaded by the browser.
 * index.html loads the precompiled js/composer.js. After editing this file,
 * rebuild with:
 *   npx -p @babel/core -p @babel/cli -p @babel/preset-react \n *     babel composer.jsx --presets @babel/preset-react -o composer.js
 * (run from static/synthograsizer/js/; any dir with the three packages works)
 */
