    ...
    controls: [
      { 
        ...
        options: [
          ...
          { value: 'ordered', label: '⏹️ Ordered' },
          { value: 'bayer', label: '📐 Bayer' },
          { value: 'halftone', label: '💠 Halftone' },
          { value: 'random', label: '🎲 Random' },
          { value: 'threshold', label: '✂️ Threshold' }
        ]
      },
      { 
        type: 'select', 
        id: 'dithering-color-mode', 
        label: 'Color Mode', 
        default: 'monochrome',
        options: [
          ...
          { value: 'commodore64', label: '🕹️ Commodore 64' },
          { value: 'web_safe', label: '🌐 Web Safe' },
          { value: 'custom', label: '🎨 Custom' }
        ]
      },
      { 
        type: 'select', 
        id: 'dithering-cga-palette', 
        label: 'CGA Palette', 
        default: '0',
        options: [
          { value: '0', label: 'Palette 0 (Cyan/Magenta)' },
          { value: '1', label: 'Palette 1 (Green/Red)' },
          { value: '2', label: 'Palette 2 (Cyan/Magenta Light)' }
        ]
      },
      { 
        type: 'slider', 
        id: 'dithering-color-levels', 
        label: 'Color Levels', 
        min: 2, 
        max: 16, 
        default: 2 
      ...
      { 
        type: 'slider', 
        id: 'dithering-levels-per-channel', 
      ...
      { 
        type: 'checkbox', 
        id: 'dithering-serpentine', 
        label: 'Serpentine Scanning', 
        default: true 
      },
      { 
        type: 'slider', 
        id: 'dithering-brightness', 
        label: 'Brightness', 
        min: -50, 
        max: 50, 
        default: 0 
