...
// Using p5-face-generator template as the default
const DEFAULT_SYNTHOGRASIZER_STATE = {
  ...
  variables: [
    { name: "head_shape", values: ["oval", "round", "square", "heart", "diamond", "rectangular"] },
    { name: "skin_tone", values: ["pale", "light", "medium", "tan", "brown", "dark"] },
    { name: "eye_color", values: ["brown", "hazel", "green", "blue", "gray", "amber"] },
    { name: "eye_shape", values: ["almond", "round", "hooded", "narrow", "wide", "upturned"] },
    { name: "eyebrow_style", values: ["arched", "straight", "thick", "thin", "bushy", "angled"] },
    { name: "hair_style", values: ["short", "long", "wavy", "curly", "bald", "straight"] },
    { name: "hair_color", values: ["black", "brown", "blonde", "red", "gray", "white"] },
    { name: "nose_shape", values: ["straight", "button", "upturned", "broad", "narrow", "long"] },
    { name: "mouth_shape", values: ["full", "thin", "wide", "small", "heart", "curved"] },
    { name: "ear_size", values: ["tiny", "small", "medium", "large", "prominent", "hidden"] },
    { name: "neck_width", values: ["very-thin", "thin", "average", "thick", "wide", "muscular"] },
    { name: "facial_hair", values: ["none", "mustache", "goatee", "full-beard", "stubble", "sideburns"] },
    { name: "accessories", values: ["none", "glasses", "sunglasses", "earrings", "hat", "both-glasses-earrings"] }
  ],
  loadP5Template: true // Flag to indicate we should load the p5 code from p5-face-generator.json
};
...
function initializeDefaultStateIfNeeded() {
  ...
  // Load p5.js code from template if flag is set
  if (DEFAULT_SYNTHOGRASIZER_STATE.loadP5Template) {
    fetch('synthograsizer/project-templates/p5-face-generator.json')
      .then(resp => resp.json())
      .then(template => {
        if (template.p5_input && template.p5_input.code && p5Code) {
          p5Code.value = template.p5_input.code;
          console.log('Loaded p5.js face generator code from template');
        }
      })
      .catch(err => {
        console.warn('Could not load p5.js template code:', err);
      });
  }
}
